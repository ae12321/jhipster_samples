...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './seat.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEAT actions', async () => {
      const expectedActions = [
        {
