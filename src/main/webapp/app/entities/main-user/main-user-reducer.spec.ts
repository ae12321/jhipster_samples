...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './main-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAINUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_MAINUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MAINUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MAINUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MAINUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MAINUSER actions', async () => {
      const expectedActions = [
        {
