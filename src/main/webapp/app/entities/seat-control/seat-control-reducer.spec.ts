...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEATCONTROL_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEATCONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEATCONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEATCONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEATCONTROL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEATCONTROL actions', async () => {
      const expectedActions = [
        {
