...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REPRESENTATIVE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REPRESENTATIVE actions', async () => {
      const expectedActions = [
        {
