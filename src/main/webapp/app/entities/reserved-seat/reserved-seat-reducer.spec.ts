...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESERVEDSEAT_LIST actions', async () => {
    ...
    it('dispatches FETCH_RESERVEDSEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESERVEDSEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESERVEDSEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESERVEDSEAT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESERVEDSEAT actions', async () => {
      const expectedActions = [
        {
