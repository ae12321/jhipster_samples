...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEATGROUP_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEATGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEATGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEATGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEATGROUP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEATGROUP actions', async () => {
      const expectedActions = [
        {
