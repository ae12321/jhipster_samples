...
class ReservedSeatResourceIT {
    ...
    void createReservedSeat() throws Exception {
        ...
        assertThat(testReservedSeat.getPersonName()).isEqualTo(DEFAULT_PERSON_NAME);
        assertThat(testReservedSeat.getSeatName()).isEqualTo(DEFAULT_SEAT_NAME);
    }
    ...
    void putExistingReservedSeat() throws Exception {
        ...
        updatedReservedSeat.personName(UPDATED_PERSON_NAME).seatName(UPDATED_SEAT_NAME);
        ...
        ReservedSeat testReservedSeat = reservedSeatList.get(reservedSeatList.size() - 1);
        assertThat(testReservedSeat.getPersonName()).isEqualTo(UPDATED_PERSON_NAME);
        assertThat(testReservedSeat.getSeatName()).isEqualTo(UPDATED_SEAT_NAME);
    }
    ...
    void partialUpdateReservedSeatWithPatch() throws Exception {
        ...
        partialUpdatedReservedSeat.personName(UPDATED_PERSON_NAME);
    ...
    void fullUpdateReservedSeatWithPatch() throws Exception {
        ...
        partialUpdatedReservedSeat.personName(UPDATED_PERSON_NAME).seatName(UPDATED_SEAT_NAME);
